...
const renderEventsLanding = () => [
  ...
  `          <p class="events-socials" aria-label="Redes sociales"><a href="${CONTACT_URL}" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:none">WhatsApp</a> · <a href="https://www.instagram.com/sushiclub_ar/" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:none">Instagram</a> · <a href="https://www.facebook.com/sushiclubargentina" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:none">Facebook</a> · <a href="https://www.tiktok.com/@sushiclub_ar" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:none">TikTok</a> · <a href="https://www.linkedin.com/company/sushiclub/posts/" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:none">LinkedIn</a></p>`,
  '        </section>',
